...
888b.      8   8    d88b   .d88b. 
8wwwP      8www8    " dP   8P  Y8 
8   b wwww 8   8     dP    8b  d8 
888P'      8   8    d888 w `Y88P' 
                                  

         
 \033[38;5;6m╔════════════════════════════════════════════════╗
 \033[38;5;6m║     \033[38;5;195m[\033[38;5;45m✓\033[38;5;195m] \033[38;5;195mCREATED BY\033[38;5;196m   :  \033[38;5;146mHRIDOY CHOWDURY RAIHAN    \033[38;5;6m║
 \033[38;5;6m║     \033[38;5;195m[\033[38;5;45m✓\033[38;5;195m] \033[38;5;195mFACEBOK      \033[38;5;196m: \033[38;5;146m HRIDOY CHOWDURY RAIHAN                 \033[38;5;6m║
 \033[38;5;6m║     \033[38;5;195m[\033[38;5;45m✓\033[38;5;195m] \033[38;5;195mGITHUB       \033[38;5;196m:  \033[38;5;146mB-HACKER 2.0                \033[38;5;6m║
 ...
 \033[38;5;6m║     \033[38;5;195m[\033[38;5;45m✓\033[38;5;195m] \033[38;5;195mTEAM         \033[38;5;196m:  \033[38;5;146mB-HACKER                    \033[38;5;6m║
 ...
 \033[38;5;6m╚════════════════════════════════════════════════╝
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m @Itsmdrabbiofficial
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m Ruhitul-Rabbi
 \033[38;5;6m══════════════════════════════════════════════════
    """)
...
class Ifty:
    def __init__(self):
        ...
        if Ornita in ["2","02"]:
            naima()
        if Ornita in [" 3", "03"]:
        	os.system('xdg-open https://www.facebook.com/itsmdrabbiofficial')
        if Ornita in [" 0", "00"]:
            exit()
        else:
            exit()
def asha():
    ...
    kodex = ''.join(random.choice(string.digits) for _ in range(4))
    kod = ''.join(random.choice(string.digits) for _ in range(4))
    os.system('clear')
    print(logo)
    #print(prity)
    ...
    with ThreadPool(max_workers=30) as raifa:
        ...
        print(' [+] Save As /sdcard/Rabbi-ok.txt')
        print(' [!] Save As /Sdacrd/Rabbi-cp.txt')
...
def naima():
   ...
   # print(prity)
    ...
    with ThreadPool(max_workers=30) as raifa:
        ...
        print(' [+] Save As /sdcard/bhacker-ok.txt')
        print(' [!] Save As /Sdacrd/bhacker-cp.txt')
        print(' [!] Use flight mode for speed up ')
        #print(prity)
        for guru in user:
...
def sabina(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;92m[bhacker]\033[1;95m [{uid}]\033[1;92m[%s]\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
            sys.stdout.flush()
